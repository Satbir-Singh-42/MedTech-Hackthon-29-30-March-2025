  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute top-0 right-0 w-96 h-96 bg-pink-500/20 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: "12s", right: "5%", top: "10%" }}></div>
        <div
          className="absolute bottom-0 left-0 w-80 h-80 bg-indigo-500/20 rounded-full blur-3xl animate-pulse"
              ...
              <div className="space-y-4">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl shadow-2xl mb-4">
                  <svg viewBox="0 0 100 100" className="w-12 h-12">
                    <path
                      d="M50 10 C30 10, 10 30, 10 50 C10 70, 30 90, 50 90 C70 90, 90 70, 90 50 C90 30, 70 10, 50 10 M45 35 L45 45 M55 35 L55 45 M35 55 Q50 70, 65 55"
                      fill="none"
                      stroke="white"
                      strokeWidth="4"
                      strokeLinecap="round"
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-center lg:justify-start space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-400 text-sm">
                      Compassionate conversations whenever you need them
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center lg:justify-start space-x-4">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-gray-400 text-sm">
                      Personalized mindfulness practices for your journey
                    </p>
                  </div>
                </div>
              </div>
